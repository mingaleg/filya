...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('collector_battleserial', (
            ...
            ('player1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='played1', to=orm['collector.Battle'])),
            ('player2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='played2', to=orm['collector.Battle'])),
        ...
        # Adding field 'Battle.serial'
        db.add_column('collector_battle', 'serial',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['collector.BattleSerial'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Battle.serial'
        db.delete_column('collector_battle', 'serial_id')
    ...
    models = {
        ...
        'collector.battleserial': {
            ...
            'player1': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'played1'", 'to': "orm['collector.Battle']"}),
            'player2': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'played2'", 'to': "orm['collector.Battle']"}),
