...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BattleSerial.id'
        db.delete_column('collector_battleserial', 'id')

        # Adding field 'BattleSerial.sid'
        db.add_column('collector_battleserial', 'sid',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
                      keep_default=False)

        # Adding field 'BattleSerial.winner'
        db.add_column('collector_battleserial', 'winner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collector.Submit'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'BattleSerial.failed'
        db.add_column('collector_battleserial', 'failed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'BattleSerial.player2'
        db.alter_column('collector_battleserial', 'player2_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collector.Submit']))

        # Changing field 'BattleSerial.player1'
        db.alter_column('collector_battleserial', 'player1_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collector.Submit']))

    def backwards(self, orm):
        # Adding field 'BattleSerial.id'
        db.add_column('collector_battleserial', 'id',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
                      keep_default=False)

        # Deleting field 'BattleSerial.sid'
        db.delete_column('collector_battleserial', 'sid')

        # Deleting field 'BattleSerial.winner'
        db.delete_column('collector_battleserial', 'winner_id')

        # Deleting field 'BattleSerial.failed'
        db.delete_column('collector_battleserial', 'failed')


        # Changing field 'BattleSerial.player2'
        db.alter_column('collector_battleserial', 'player2_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collector.Battle']))

        # Changing field 'BattleSerial.player1'
        db.alter_column('collector_battleserial', 'player1_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collector.Battle']))
