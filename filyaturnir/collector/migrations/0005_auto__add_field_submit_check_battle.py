...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submit.check_battle'
        db.add_column('collector_submit', 'check_battle',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collector.Battle'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submit.check_battle'
        db.delete_column('collector_submit', 'check_battle_id')
